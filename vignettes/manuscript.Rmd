...
Though we observed relatively small decreases in CH~4~ emissions during the salinization period (Fig. 4), we observed strong changes in connectivity strength (Fig. 2) and information transfer (Fig. 4) between driving processes (*Ta* and *GEP*) and CH~4~ fluxes across the disturbance period. During the high salinity period (2015-2016), couplings (*MI*) and information transfer (*TE*) from *Ta* to *F~CH4~* strengthened (Fig. 2 and 4, respectively), and coupling and information transfer from *GEP* to *F~CH4~* declined (Fig. 2 and 4, respectively). These observations, taken with the findings of small reductions in daily to annual *F~CH4~* (Fig. 5), suggest that either (1) microbial utilization of other weltand C substrates compenstates for a reduction in utilization of recent photosynthates, or (2) recent photosynthates are not an important driver of CH~4~ production and emissions within these wetland systems. This stands in constrast to previous eddy covariance studies conducted on rice paddies in the Sacramento-San Joaquin Delta, where it was found that *GEP* was the dominant driver of CH~4~ fluxes compared to temperature [@hatala_gross_2012; @knox_biophysical_2016]. Using conditional Granger causality, @hatala_gross_2012 found that the diurnal pattern in CH~4~ emissions was driven by *GEP*, rather than temperature, at ~1.5 hour lags. Our findings stand in contrast to these, as we observe increased information transfer from temperature to CH~4~ fluxes, and a corresponding loss of information transfer from *GEP* to CH~4~ fluxes, during the peak salinization period (Fig. 4). Decoupling from plant productivity and CH~4~ fluxes can also be observed empirically in the reduction in *GEP* in late-2016 that was not associated with a similar reduction in CH~4~ flux (Fig. 5). These differences between rice and wetland ecosystems in the same region suggests that dominant biogeochemical processes can vary widely across ecosystem types, as is also evident from a long history of biogeochemical studies [@bridgham_methane_2013], and caution should be taken in extrapolating findings from one ecosystem to another.

Our findings also demonstrate the utility of applying information theory and machine learning approaches to understanding ecosystem response to disturbance. Information theory metrics are particulary suited to studying complex systems due to their ability to resolve non-linear interactions without any assumption of functional form [@rinderer_assessing_2018] and their ability to resolve scale-dependent interactions [@sturtevant_identifying_2016; @larsen_disrupted_2017; @chamberlain_soil_2018; @knox_direct_2018]. Utilizing these approaches generally requires large datasets [@ruddell_ecohydrologic_2009], which are becoming increasingly available through FluxNet and other ecological networks [@baldocchi_fluxnet_2001; @hampton_big_2013], and we reccomend these approaches to quantifying the effect of disturbance through observational data. These tools provide a strong foundation for causal inference in natural ecosystems, where large-scale experiements may be impractical or impossible.
