...
We observe a similar transition in the hierarchy of coupling between the low salinity period (2012-2013) and the high salinity period (2015-2016) in the transfer of information from *GEP* or *Ta* to *F~CH4~* (Fig. 4). During the low salinity period, we observed similar magnitude *TE* for *GEP* to *F~CH4~* and *Ta* to *F~CH4~*, where significant transfer of information from *GEP* to *F~CH4~* occurred between 0-12 hour time lags and *GEP* from the previous day (over 24 hour lags) also affected current *F~CH4~* (Fig. 2). These transfers were still observable during 2015, but by 2016 during peak salinity only weak significant *TE* was observed at 0-3 hour lags from *GEP* to *F~CH4~* (Fig. 4). We observed a very different dynamic for *TE* from *Ta* to *F~CH4~* that mirrors our *MI* observations, where *TE*(*Ta* > *F~CH4~*) was of similar magnitude to *TE*(*GEP* > *F~CH4~*) during the low salinity years (2012 & 2013), and these directional couplings strengthened during the high salinity periods in 2015 and 2016 (Fig. 4). Regardless of *TE* strength, under most conditions *Ta* at time lags up to ~30 hours affected current CH~4~ flux rates (Fig. 4). Transfer entropy from 2014 and 2017 was not evaluated in this analysis because insect outbreakand flushing disturbances also affected the wetlands and limit our ability to evaluate the affect of salinization alone.
