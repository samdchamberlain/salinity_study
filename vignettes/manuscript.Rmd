...
a <- ggplot(subset(peat6_daily, year > 2012), aes(x=datetime, y=mgCH4)) +
  geom_point()

b <- ggplot(subset(peat6_daily, year > 2012), aes(x=datetime, y=gCO2)) +
  geom_point()

c <- ggplot(subset(peat6_daily, year > 2012)) +
  geom_line(aes(x=datetime, y=gER)) +
  geom_line(aes(x=datetime, y=gGEP))

d <- ggplot(subset(peat6_daily, year > 2012), aes(x=datetime, y=Cond)) +
  geom_line()
