...
We observed a substantial increase in salinity over the course of our observation period. Salinity levels were relatively stable from 2012 through 2013, began to rise through 2014, peaked in 2017, and reduced rapidly in 2017 when site managers flushed the wetland system with freshwater (Fig. 1). Coupling between driver variables (*GEP* and *Ta*) and *F~CH4~* were similar in the pre-disturbance period (2012 & 2014) where maximum *MI* was observed during the growing season and were of similar magnitude for *MI~Ta,FCH4~* and *MI~GEP,FCH4~* (Fig. 1). During 2014, *MI* did not display a similar seasonality, presumabely due to a large-scale insect outbreak that affected the wetland, though at late season increase in *MI* was still observed for *MI~Ta,FCH4~* and *MI~GEP,FCH4~*. During 2015 and 2016, the peak of the salinity disturbance, we observed a strong decoupling between *GEP* and *F~CH4~*, as well as a strengthening in the coupling between *Ta* and *F~CH4~* compared with the previous years (Fig. 1). The decoupling of *GEP* and *F~CH4~* across 2015 and 2016 is not driven by a crash in the *GEP* flux magnitude, as *GEP* magnitudes within the season were similar to previous years (Supporting Information; Fig. S2). During the managed flushing period of 2017 when salinity levels dropped steeply, couplings between *GEP* and *F~CH4~* began to recover but were highly variable throughout the season as salinity changed (Fig. 1).

```{r figx, fig.width=3, fig.height=7, dpi=600}
...
We observe a similar transition in the hierarchy of coupling between the low salinity period (2012-2013) and the high salinity period (2015-2016) in the transfer of information from *GEP* or *Ta* to *F~CH4~* (Fig. 3). During the low salinity period, we observed similar magnitude *TE* for *GEP* to *F~CH4~* and *Ta* to *F~CH4~*, where significant transfer of information from *GEP* to *F~CH4~* occurred between 0-12 hour time lags and *GEP* from the previous day (over 24 hour lags) also affected current *F~CH4~* (Fig. 1). These transfers were still observable during 2015, but by 2016 during peak salinity only weak significant *TE* was observed at 0-3 hour lags from *GEP* to *F~CH4~* (Fig. 3). We observed a very different dynamic for *TE* from *Ta* to *F~CH4~* that mirrors our *MI* observations, where *TE*(*Ta* > *F~CH4~*) was of similar magnitude to *TE*(*GEP* > *F~CH4~*) during the low salinity years (2012 & 2013), and these directional couplings strengthened during the high salinity periods in 2015 and 2016 (Fig. 3). Regardless of *TE* strength, under most conditions *Ta* at time lags up to ~30 hours affected current CH~4~ flux rates (Fig. 3). Transfer entropy from 2014 and 2017 was not evaluated in this analysis because insect outbreakand flushing disturbances also affected the wetlands and limit our ability to evaluate the affect of salinization alone.

```{r fig3, fig.cap="Normalized transfer entropy (***TE***) from (top panel) half-hourly GEP to F~CH4~ and (bottom panel) T~a~ to F~CH4~ over the growing season during years of low salinity (2012-2013) and high salinity (2015-2016). The red line represents significance threshold (*P* < 0.05) based on Monte Carlo reshuffling of the time series. Other lines represented ***TE*** at various lags of GEP or T~a~ and color demonstrates mean salinity (psu) during the respective year. Years 2014 and 2017 are omitted from analysis because other disturbance events affected wetlands processes and confound analyses.", fig.height=4, fig.width=7.5, dpi=600}
...
```{r fig4, fig.width=7.5, fig.height=4}
...
Model predictions during the high salinity period demonstrate that CH~4~ fluxes were not substantially lower than expected if the impact of salinity was not taken into account (Fig. 4). During 2015, annual CH~4~ flux observations were only `r annual_budgets$CH4pc[annual_budgets$year == 2015]`% below the model predictions, though during 2016, observed annual budgets were `r annual_budgets$CH4pc[annual_budgets$year == 2016]`% below the model predictions. A much larger effect was observed for *GEP*, where observed *GEP* was substantially below the random forest predictions not accounting for salinity effects, particularly during the growing season of 2016 when salinity levels were highest (Fig. 4). During 2015, observed annual *GEP* budgets were `r annual_budgets$GEPpc[annual_budgets$year == 2015]`% lower than predictions, and during 2016 annual *GEP* observations were `r annual_budgets$GEPpc[annual_budgets$year == 2016]`% lower than predictions assuming no effect of salinity. This modeling exercise demonstrates the disproportionate effect of this form of wetland salinization on *GEP* rather than CH~4~ emissions.
