---
title: Effect of drought-induced salinization on wetland ecosystem methane emissions, gross ecosystem productivity, and their interactions.
...
```{r fig1, fig.cap = "Monthly cumulative fluxes of methane (*F~CH4~*), gross ecosystem photosynthesis (*GEP*), ecosystem respiration (*ER*), as well as mean salinity at the salinization wetland. The wetland was one year old and fully vegetated by 2012.", fig.width=3, fig.height=7, dpi=600}
...
```{r fig5, fig.cap="Daily observed (black) and modeled (red) methane flux (*F~CH4~*; top panel) and gross ecosystem photosynthesis (*GEP*; bottom panel) during the high salinity period. Model predictions were made using random forest models trained on data collected in previous years (2012-2014) when salinity levels were low.", fig.width=7.5, fig.height=4, dpi=600}
