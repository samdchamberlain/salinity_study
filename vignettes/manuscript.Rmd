...
tr_wm_gpp <- tr_timeseries(GPP_anom, CH4_anom, data_list = by_year, type = "observed", lags = 48*2, bins = 10)
mc_wm_gpp <- tr_timeseries(GPP_anom, CH4_anom, data_list = by_year, type = "shuffled", lags = 48*2, bins = 10)
...
ggplot(tawm_df) +
  ...
  geom_line(aes(x = hour, y = mc_wm*2.36), color = "red") +
  facet_wrap(~year) +
